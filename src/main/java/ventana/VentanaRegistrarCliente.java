...
public class VentanaRegistrarCliente extends Ventana {
    ...
    private boolean registrarCliente(){
        return automotora.agregarClientes(this.campoNombre.getText(),this.campoDireccion.getText(),this.campoNumeroTelefonico.getText(),
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.botonRegistrar) {
            if(registrarCliente()) {
                ...
                VentanaMenuPrincipal ventanaMenuPrincipal = new VentanaMenuPrincipal(automotora);
                this.dispose();
            }
            else{
